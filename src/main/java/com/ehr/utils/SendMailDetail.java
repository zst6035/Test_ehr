...
public class SendMailDetail {
        ...
        public static void sendMail(String[] tos, File file) throws Exception {
            ...
            try {
               ...
               //添加普通文本文件
            //    contentPart.setText("这里是正文");
                    //添加html文件,但是这种方式html中的图片为显示；


                contentPart.setDataHandler(new DataHandler(TestConfig.getFiletoString(file),
                        "text/html;charset=gb2312"));
             //   contentPart.setContent(TestConfig.getFiletoString(file),"text/html;charset=utf-8");
...
//           设置后，附件不会出现乱码
    ...
    public static void main(String[] args) throws Exception {
       ...
       list[0]="1148744992@qq.com";
       list[1]="shouting_zhang@baofu.com";
